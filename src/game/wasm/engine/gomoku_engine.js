...
export class Game {
     ...
     */
    ai_move(difficulty) {
        const ret = wasm.game_ai_move(this.__wbg_ptr, difficulty);
        return ret;
    }
    /**
     * @returns {string}
    ...
    current_player() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.game_current_player(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    is_draw() {
        const ret = wasm.game_is_draw(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    move_count() {
        const ret = wasm.game_move_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    constructor() {
     ...
     */
    play_move(x, y) {
        const ret = wasm.game_play_move(this.__wbg_ptr, x, y);
        return ret !== 0;
    }
    reset() {
