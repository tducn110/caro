...
import { type GameMode, type Move } from "../game/types"
...
export const InfoCard = memo(function InfoCard({ mode, elapsed, compact }: { mode: GameMode; elapsed: number; compact?: boolean }) {
  return (
    <div
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: compact ? "row" : "column", gap: compact ? 16 : 8, flex: 1 }}>
        ...
        <InfoRow icon={<Grid3X3 size={12} />} label="Kích thước" value="Vô hạn" />
...
export const HistoryPanel = memo(function HistoryPanel({ history, compact }: { history: Move[]; compact?: boolean }) {
